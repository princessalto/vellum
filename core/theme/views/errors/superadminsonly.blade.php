@if (user() && user()->isSuperAdmin())
  <div id="accordion">
    <div class="mt-4">
      <a class="h6 text-primary" href="#" data-toggle="collapse" data-target="#debug-message-body" aria-expanded="false" aria-controls="debug-message-body">{{ __('Error Description') }}&nbsp;<i class="mdi mdi-plus small"></i></a>
