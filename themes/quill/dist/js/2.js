...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils_user_user__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @/utils/user/user */ "./src/utils/user/user.js");
/* harmony import */ var _utils_user_user__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_utils_user_user__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @/store */ "./src/store/index.js");
/* harmony import */ var _utils_auth_login__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @/utils/auth/login */ "./src/utils/auth/login.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    login: function login(e) {
      ...
      Object(_utils_auth_login__WEBPACK_IMPORTED_MODULE_2__["default"])({
        username: username,
        password: password
      }).then(function () {
...
var URL_POST_LOGIN = '/api/v1/login';
...
var login = function login(user) {
  return new Promise(function (resolve, reject) {
    window.axios({
      ...
      var token = response.data.token; // const id = response.data.user.id
